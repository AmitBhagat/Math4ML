...
export const CALCULUS_DATA: CategoryData = {
  id: "calculus",
  title: "Calculus",
  description: "The mathematical engine of optimization, power transitions, and gradient-based learning.",
  keyConcepts: [
    { title: "Differentiation", description: "Calculating rates of change." },
    { title: "Gradients", description: "Vectors of steepest ascent." },
    { title: "Backpropagation", description: "Efficient error distribution." }
  ],
  sections: [
    {
      id: "differentiation",
      title: "Derivatives & Optimization",
      description: "Foundational calculus for understanding gradient descent and error minimization.",
