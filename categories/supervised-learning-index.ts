...
export const SUPERVISED_LEARNING_DATA: CategoryData = {
  ...
  sections: [
    ...
    },
    {
      ...
      description: "Mapping inputs to discrete categories using Logistic Regression and Probabilistic modeling.",
      html: String.raw`
        <div class="premium-hero">
          <div class="premium-hero-badge">🎯 ML · Supervised</div>
      ...
      `,
      tags: ["Logistics", "Sigmoid", "Log-Loss"],
      color: "#58a6ff"
    },
    {
      id: "svm-trees",
      title: "SVM & Decision Trees",
      description: "Advanced non-linear boundaries using Max-Margin Hyperplanes and Information Gain.",
      html: String.raw`
        <div class="premium-hero">
          <div class="premium-hero-badge">🌲 ML · Supervised</div>
