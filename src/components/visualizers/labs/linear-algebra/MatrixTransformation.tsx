...
const MatrixTransformation = () => {
    ...
    useEffect(() => {
        ...
        // Create Sliders
        const a = board.create('slider', [[-5, -3.5], [5, -3.5], [-5, 1, 5]], { name: 'a', snapWidth: 0.1, color: '#E98074' });
        const b = board.create('slider', [[-5, -4.5], [5, -4.5], [-5, 0, 5]], { name: 'b', snapWidth: 0.1, color: '#E98074' });
        const c = board.create('slider', [[-5, -5.5], [5, -5.5], [-5, 0, 5]], { name: 'c', snapWidth: 0.1, color: '#E98074' });
        const d = board.create('slider', [[-5, -6.5], [5, -6.5], [-5, 1, 5]], { name: 'd', snapWidth: 0.1, color: '#E98074' });
