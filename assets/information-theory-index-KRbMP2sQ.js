...
print(f"Entropy: {calculate_entropy(probs):.4f} bits")
  ...
  `},i={id:"kl-divergence",title:"KL Divergence",description:"KL Divergence, or Relative Entropy, measures how much one probability distribution differs from a reference distribution.",html:String.raw`
    <div class="premium-hero">
