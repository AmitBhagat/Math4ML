const e={id:"inferential-statistics",title:"Foundations of Inferential Statistics",description:"A comprehensive exploration of hypothesis testing, p-values, t-tests, chi-square analysis, and confidence intervals, bridging sample statistics to population parameters with applications in ML validation.",formula:"t = \\frac{\\bar{x} - \\mu}{s / \\sqrt{n}}",details:["Epistemology of Inference: Population vs Sample Dynamics","Hypothesis Testing: Fisher vs Neyman-Pearson Philosophies","Error Typology: Type I (alpha) and Type II (beta) errors","Student's t-Test: Derivation and Experimental Variations","Pearson’s Chi-Square Test: Goodness-of-Fit and Independence","Mathematical Construction of Confidence Intervals (CI)","HT-CI Duality: The Equivalence Theorem","Machine Learning Implications: Power Calculations and A/B Testing"],html:String.raw`
...
print(f"t-statistic: {t_stat:.4f}, p-value: {p_val:.4f}")
  ...
  `},t={id:"parameter-estimation",title:"MLE, MAP, & Bias-Variance",description:"A comprehensive investigation into Maximum Likelihood Estimation (MLE), Maximum A Posteriori (MAP) estimation, and the Bias-Variance Tradeoff—the three pillars of statistical learning and generalization.",formula:"L(\\theta) = \\prod_{i=1}^{n} f(x_i; \\theta)",details:["Frequentist vs. Bayesian Paradigms in Parametric Inference","Maximum Likelihood Estimation (MLE): Mechanics and I.I.D. Assumptions","Log-Likelihood Transformations for Gaussian and Bernoulli models","Maximum A Posteriori (MAP): Conjugate Priors and Beta-Bernoulli models","Bayesian Regularization: Connecting MAP to Ridge (L2) and Lasso (L1)","Formal Derivation of Bias-Variance Decomposition","Complexity Tradeoff Curves: Underfitting vs. Overfitting dynamics","Empirical Risk Minimization (ERM) and Learning Theory"],html:String.raw`
    <div class="premium-toc">
      <div class="premium-toc-title">Table of Contents</div>
  ...
  `},i={id:"regression-analysis",title:"Regression Analysis Theory",description:"An exhaustive mathematical treatment of Ordinary Least Squares (OLS), the Gauss-Markov theorem, variance decomposition (ANOVA), and residual diagnostics for predictive modeling.",formula:"\\hat{\\beta} = (X^T X)^{-1} X^T Y",details:["Probabilistic Specification of Linear Models and Stochastic Errors","MATHEMATICAL DERIVATION: OLS via Calculus and Matrix Algebra","The Gauss-Markov Theorem: Why OLS is the BLUE Estimator","Decomposition of Variance: SST, SSR, and SSE Identity","The ANOVA Framework and Model Utility F-Tests","R² and Adjusted R-squared: Mechanics and Complexity Penalties","Analytical Theory of Residuals: Leverage, Influence, and Hat Matrices","Diagnostic Visual Analytics: Q-Q Plots and Heteroscedasticity Funnels","Structural Violations: Multicollinearity (VIF) and Endogeneity Bias"],html:String.raw`
    <div class="premium-toc">
      <div class="premium-toc-title">Table of Contents</div>
  ...
  `},a={id:"evaluation-metrics",title:"Statistical Evaluation Metrics",description:"Exhaustive analysis of classification and regression metrics, detailing their probabilistic underpinnings, formal derivations, and practical applications within complex model topologies.",formula:"F_1 = \\frac{2 \\cdot P \\cdot R}{P + R}",details:["Confusion Matrix Taxonomy: Type I and Type II error typology","Global Accuracy and the Imbalance Paradox in skewed datasets","Precision (PPV) and Recall (Sensitivity): Threshold-driven trade-offs","F1-Score: Harmonic mean justification and geometrical derivation","ROC-AUC: Discriminative power and equivalence to Wilcoxon-Mann-Whitney","Regression Metrics: L1 (MAE) vs. L2 (MSE) statistical properties","Proofs: Why MSE minimizes to the Mean and MAE to the Median","Information Theory: Shannon Entropy, KL Divergence, and Cross-Entropy","Optimization Dynamics: Gradient behavior of common loss functions"],html:String.raw`
    <div class="premium-toc">
      <div class="premium-toc-title">Table of Contents</div>
  ...
  `},s={id:"statistics",title:"Statistics",description:"Statistics is the science of learning from data. In Machine Learning, it provides the tools for hypothesis testing, parameter estimation, and rigorous model evaluation.",keyConcepts:[{title:"Inferential Statistics",description:"The mathematical theory of hypothesis testing, p-values, and confidence intervals."},{title:"Estimation Theory",description:"Maximum Likelihood (MLE) vs. Maximum A Posteriori (MAP) and the Bias-Variance tradeoff."},{title:"Regression Analysis",description:"The Ordinary Least Squares (OLS) framework, BLUE optimality, and model diagnostics."},{title:"Evaluation Metrics",description:"Probabilistic and information-theoretic measures of classification and regression performance."}],sections:[e,t,i,a]};export{s as STATISTICS_DATA};
