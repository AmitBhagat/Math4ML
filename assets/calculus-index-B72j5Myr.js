const t={id:"basics",title:"Introduction to Calculus",description:"Differential Calculus is the study of how functions change when their inputs change by infinitesimal amounts. In Machine Learning, it's the primary engine for optimization.",html:String.raw`
...
print(f"Current Loss: {current_loss}, Updated Weight: {new_w}")
  ...
  `},e={id:"neural-networks",title:"Calculus in Neural Networks",description:"In Deep Learning, multivariate calculus is the engine that powers optimization. Learn how the Chain Rule enables efficient training.",html:String.raw`
    <div class="premium-hero">
  ...
  `},i={id:"neural-networks-examples",title:"Practical Examples",description:"Solidify your understanding of how the Chain Rule and Partial Derivatives operate in a computational graph with two distinct examples.",html:String.raw`
    <div class="premium-hero">
  ...
  `},a={id:"multivariable",title:"Multivariable Calculus",description:"Multivariable Calculus extends the concepts of single-variable differentiation to functions of several variables. In ML, we optimize millions of parameters simultaneously.",html:String.raw`
    <div class="premium-hero">
...
print(f"Probability P(1 <= X <= 2): {probability:.4f}")
  ...
  `},r={id:"optimization",title:"Optimization Theory",description:"Optimization Theory is the study of finding the 'best' solution. In ML, this means finding weights that minimize the Loss Function.",html:String.raw`
    <div class="premium-hero">
...
for start in starts:
  ...
  `},o={id:"vector-calculus",title:"Vector Calculus",description:"Vector Calculus deals with the differentiation and integration of vector fields. Learn how divergence and curl are used to constrain AI simulations.",html:String.raw`
    <div class="premium-hero">
