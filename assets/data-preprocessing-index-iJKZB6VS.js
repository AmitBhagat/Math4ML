const e={id:"data-preprocessing",title:"Data Preprocessing",description:"Meticulous cleaning and transformation techniques (Scaling, Encoding, Imputation) required for high-quality model training.",keyConcepts:[{title:"Scaling",description:"Normalizing numerical feature ranges."},{title:"Cleaning",description:"Handling missing data and outliers."}],sections:[{id:"scaling",title:"Feature Scaling",description:"Standardization vs. Normalization for gradient stability and algorithm convergence.",html:String.raw`
      ...
      `,tags:["StandardScaler","MinMax","Robust"],color:"#ff7b72"},{id:"imputation",title:"Categorical Encoding",description:"Transforming labels and categories into numerical vectors using One-Hot and Label encoding.",html:String.raw`
        <div class="premium-hero">
          <div class="premium-hero-badge">🔡 ML · Preprocessing</div>
      ...
      `,tags:["Missing Values","One-Hot","LabelEncoding"],color:"#ff7b72"}]};export{e as DATA_PREPROCESSING_DATA};
