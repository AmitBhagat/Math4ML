const t={id:"calculus",title:"Calculus",description:"The mathematical engine of optimization, power transitions, and gradient-based learning.",keyConcepts:[{title:"Differentiation",description:"Calculating rates of change."},{title:"Gradients",description:"Vectors of steepest ascent."},{title:"Backpropagation",description:"Efficient error distribution."}],sections:[{id:"differentiation",title:"Derivatives & Optimization",description:"Foundational calculus for understanding gradient descent and error minimization.",formula:"f'(x) = \\lim_{h \\to 0} \\frac{f(x+h) - f(x)}{h}",details:["The Derivative: Instantaneous Rate of Change","Chain Rule: The Backbone of Backpropagation","Partial Derivatives: Understanding Multidimensional Impact","The Gradient Vector: Direction of Steepest Ascent","Jacobian Matrices: Derivatives of Vector-Valued Functions","Numerical Implementation: Symbolic Differentiation with SymPy"],html:String.raw`
