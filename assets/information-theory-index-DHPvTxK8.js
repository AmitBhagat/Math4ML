...
print(f"Asymmetry check: {calculate_kl(q, p):.4f}")
  ...
  `},o={id:"mutual-information",title:"Mutual Information",description:"Mutual Information quantifies the dependency between two random variables. It measures how much information X tells us about Y.",color:"#FF9800",html:String.raw`
    <div class="premium-hero">
  ...
  `,sections:[e,o,t,i]};export{s as INFORMATION_THEORY_DATA};
