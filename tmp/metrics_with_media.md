...
![](docs\statistics\media/media/image89.png){width="6.458333333333333in"
...
![](docs\statistics\media/media/image86.png){width="6.458333333333333in"
...
![](docs\statistics\media/media/image88.png){width="6.458333333333333in"
height="0.6929538495188101in"}
...
![](docs\statistics\media/media/image94.png){width="6.458333333333333in"
height="0.6929538495188101in"}
...
Precision =
![](docs\statistics\media/media/image76.png){width="1.6361253280839896in"
height="0.23590660542432196in"}

Recall =
![](docs\statistics\media/media/image90.png){width="1.6361253280839896in"
height="0.23590660542432196in"}

If the threshold is lowered to ensure all malignant tumors are caught
(Recall
![](docs\statistics\media/media/image99.png){width="0.20170384951881015in"
...
(![](docs\statistics\media/media/image47.png){width="0.1574332895888014in"
height="0.2676367016622922in"}) and Recall
(![](docs\statistics\media/media/image108.png){width="0.15471128608923884in"
height="0.26300962379702536in"}). It is defined as the harmonic mean of
the two.^1^

![](docs\statistics\media/media/image110.png){width="6.458333333333333in"
height="0.6929538495188101in"}

Expanding this using the raw counts from the confusion matrix ^4^:

![](docs\statistics\media/media/image93.png){width="6.458333333333333in"
height="0.6929538495188101in"}
...
(![](docs\statistics\media/media/image92.png){width="0.7967563429571304in"
...
![](docs\statistics\media/media/image101.png){width="0.6841852580927384in"
height="0.25847003499562554in"} and
![](docs\statistics\media/media/image109.png){width="0.6814632545931758in"
height="0.2603346456692913in"}, the arithmetic mean is
![](docs\statistics\media/media/image98.png){width="0.2578127734033246in"
...
![](docs\statistics\media/media/image105.png){width="0.2578127734033246in"
...
- **FPR (1 - Specificity):** The proportion of actual negatives
  ...
  ![](docs\statistics\media/media/image96.png){width="6.458333333333333in"
  height="0.733902012248469in"}

- The curve typically begins at
  ![](docs\statistics\media/media/image103.png){width="0.4483902012248469in"
  height="0.2355949256342957in"}, representing a threshold so high that
  no positives are identified, and ends at
  ![](docs\statistics\media/media/image111.png){width="0.4483902012248469in"
...
![](docs\statistics\media/media/image81.png){width="0.3312029746281715in"
height="0.25592957130358707in"} and a randomly chosen negative instance
![](docs\statistics\media/media/image61.png){width="0.3483661417322835in"
...
Let
![](docs\statistics\media/media/image80.png){width="0.3755916447944007in"
height="0.2606146106736658in"} be the True Positive Rate and
![](docs\statistics\media/media/image24.png){width="0.3875470253718285in"
height="0.2635323709536308in"} be the False Positive Rate at threshold
![](docs\statistics\media/media/image45.png){width="7.291666666666667e-2in"
height="0.2754625984251968in"}.^13^

1.  ![](docs\statistics\media/media/image79.png){width="2.2065627734033244in"
    height="0.2578116797900262in"}

2.  ![](docs\statistics\media/media/image95.png){width="2.2185104986876643in"
    height="0.25832020997375327in"}

The AUC is defined as the integral of
![](docs\statistics\media/media/image74.png){width="0.14571412948381451in"
height="0.26075240594925636in"} with respect to
![](docs\statistics\media/media/image70.png){width="0.1576706036745407in"
height="0.26804024496937884in"} ^13^:

![](docs\statistics\media/media/image9.png){width="6.458333333333333in"
height="0.7622495625546807in"}

Let
![](docs\statistics\media/media/image15.png){width="0.4094455380577428in"
...
![](docs\statistics\media/media/image12.png){width="0.5664063867016623in"
height="0.2602405949256343in"}.^13^ Performing a change of variables
where
![](docs\statistics\media/media/image21.png){width="0.8669510061242345in"
height="0.2585640857392826in"}, we obtain:

![](docs\statistics\media/media/image25.png){width="6.458333333333333in"
...
![](docs\statistics\media/media/image18.png){width="6.458333333333333in"
...
![](docs\statistics\media/media/image16.png){width="6.458333333333333in"
height="0.7276017060367455in"}

Where
![](docs\statistics\media/media/image38.png){width="0.15968175853018374in"
height="0.27145997375328085in"} is the number of pairs
![](docs\statistics\media/media/image2.png){width="0.9262554680664917in"
...
- Tortoises 3, 4, 5, 6 beat 1 hare each. Total
  ![](docs\statistics\media/media/image5.png){width="2.73662510936133in"
  height="0.25774278215223095in"}.^16^

The maximum possible
![](docs\statistics\media/media/image38.png){width="0.15968175853018374in"
height="0.27145997375328085in"} is
![](docs\statistics\media/media/image4.png){width="0.9187981189851269in"
height="0.2353947944006999in"}.

![](docs\statistics\media/media/image1.png){width="1.9496872265966754in"
...
![](docs\statistics\media/media/image14.png){width="0.5785990813648294in"
...
![](docs\statistics\media/media/image3.png){width="6.458333333333333in"
height="0.6929538495188101in"}
...
predicted scalar
![](docs\statistics\media/media/image17.png){width="0.10606080489938757in"
height="0.25291338582677164in"} and the ground-truth
![](docs\statistics\media/media/image22.png){width="0.10606080489938757in"
height="0.27738845144356955in"}. The residuals, defined as
![](docs\statistics\media/media/image43.png){width="0.9835465879265092in"
...
![](docs\statistics\media/media/image39.png){width="6.458333333333333in"
height="0.8454046369203849in"}

MSE corresponds to the squared Euclidean
(![](docs\statistics\media/media/image32.png){width="0.2181583552055993in"
...
![](docs\statistics\media/media/image30.png){width="8.73578302712161e-2in"
height="0.2700153105861767in"} that minimizes the MSE for a set of
values
![](docs\statistics\media/media/image52.png){width="0.8226804461942258in"
height="0.2589916885389326in"}, we define the objective function:

![](docs\statistics\media/media/image35.png){width="6.458333333333333in"
height="0.8454046369203849in"}
...
![](docs\statistics\media/media/image44.png){width="6.458333333333333in"
height="0.6860247156605425in"}

![](docs\statistics\media/media/image84.png){width="6.458333333333333in"
height="0.5959405074365705in"}

![](docs\statistics\media/media/image48.png){width="6.458333333333333in"
height="0.6721653543307087in"}
...
![](docs\statistics\media/media/image23.png){width="6.458333333333333in"
height="0.8454046369203849in"}

MAE corresponds to the Manhattan
(![](docs\statistics\media/media/image33.png){width="0.2181583552055993in"
...
![](docs\statistics\media/media/image26.png){width="6.458333333333333in"
height="0.8454046369203849in"}

Using the Leibniz integral rule to differentiate the objective function
(split into two parts where
![](docs\statistics\media/media/image34.png){width="0.5139676290463692in"
height="0.26081911636045496in"} and
![](docs\statistics\media/media/image36.png){width="0.5139676290463692in"
height="0.26081911636045496in"}) ^26^:

![](docs\statistics\media/media/image28.png){width="6.458333333333333in"
height="0.7483902012248469in"}

![](docs\statistics\media/media/image27.png){width="6.458333333333333in"
height="0.7414610673665791in"}

![](docs\statistics\media/media/image29.png){width="6.458333333333333in"
height="0.5405041557305337in"}
...
![](docs\statistics\media/media/image20.png){width="0.9751421697287839in"
height="0.23433617672790902in"}, where
![](docs\statistics\media/media/image72.png){width="0.20170384951881015in"
height="0.2404932195975503in"} is an outlier.^25^

- **MAE:**
  ![](docs\statistics\media/media/image67.png){width="2.129021216097988in"
  height="0.23571303587051617in"}

- **MSE:**
  ![](docs\statistics\media/media/image54.png){width="2.6535312773403326in"
  height="0.23502734033245845in"}

- **RMSE:**
  ![](docs\statistics\media/media/image53.png){width="1.3557086614173228in"
...
better.^20^
  ...
  **Units**               Squared units (e.g.,                                                         Same as original data
                          ![](docs\statistics\media/media/image68.png){width="0.18158136482939632in"   (e.g., \$\$
...
![](docs\statistics\media/media/image64.png){width="0.15956474190726158in"
...
![](docs\statistics\media/media/image55.png){width="0.11541119860017497in"
height="0.26159886264216975in"} has probability
![](docs\statistics\media/media/image65.png){width="0.4298064304461942in"
height="0.26095363079615047in"}, its information content
![](docs\statistics\media/media/image63.png){width="0.38861220472440944in"
height="0.26425634295713035in"} is:

![](docs\statistics\media/media/image51.png){width="6.458333333333333in"
height="0.5405041557305337in"}

The Shannon Entropy
![](docs\statistics\media/media/image42.png){width="0.49834317585301835in"
height="0.2567224409448819in"} is the expected value of the information
content ^28^:

![](docs\statistics\media/media/image40.png){width="6.458333333333333in"
height="0.7414610673665791in"}
...
![](docs\statistics\media/media/image62.png){width="0.5859372265966755in"
...
Cross-entropy
![](docs\statistics\media/media/image46.png){width="0.7476323272090989in"
...
![](docs\statistics\media/media/image50.png){width="6.458333333333333in"
height="0.7414610673665791in"}
...
![](docs\statistics\media/media/image19.png){width="6.960192475940508e-2in"
height="0.26294181977252845in"}, we have a label
![](docs\statistics\media/media/image97.png){width="0.8973720472440945in"
height="0.25856517935258094in"} and a predicted probability
![](docs\statistics\media/media/image107.png){width="0.1576706036745407in"
...
![](docs\statistics\media/media/image106.png){width="6.458333333333333in"
height="0.8454046369203849in"}

To find the optimal parameters
![](docs\statistics\media/media/image41.png){width="0.10026027996500438in"
height="0.2622200349956256in"}, we maximize the log-likelihood (LL):

![](docs\statistics\media/media/image11.png){width="6.458333333333333in"
height="0.8454046369203849in"}

The standard Binary Cross-Entropy (BCE) loss is the negative average
log-likelihood ^31^:

![](docs\statistics\media/media/image37.png){width="6.458333333333333in"
height="0.8454046369203849in"}

For multi-class classification, this is extended using the Softmax
function to generate a probability vector for
![](docs\statistics\media/media/image31.png){width="0.15861767279090114in"
height="0.26965004374453194in"} classes ^34^:

![](docs\statistics\media/media/image10.png){width="6.458333333333333in"
height="0.9008409886264217in"}

Where
![](docs\statistics\media/media/image8.png){width="0.2632567804024497in"
height="0.2632567804024497in"} is 1 if the true class for sample
![](docs\statistics\media/media/image19.png){width="6.960192475940508e-2in"
height="0.26294181977252845in"} is
![](docs\statistics\media/media/image13.png){width="9.457895888013998e-2in"
height="0.2679724409448819in"}, and 0 otherwise. This unrolling of the
sum shows that for each sample, the loss is simply
![](docs\statistics\media/media/image6.png){width="1.246687445319335in"
...
- **MSE Gradients:** The derivative of
  ![](docs\statistics\media/media/image7.png){width="0.6962598425196851in"
  height="0.25731299212598424in"} is
  ![](docs\statistics\media/media/image69.png){width="0.7163823272090989in"
...
- **MAE Gradients:** The derivative of
  ![](docs\statistics\media/media/image59.png){width="0.5707863079615048in"
  height="0.25875656167979005in"} is
  ![](docs\statistics\media/media/image75.png){width="0.2578127734033246in"
...
- The **vanishing gradient** problem occurs when the Sigmoid output is
  ...
  ![](docs\statistics\media/media/image60.png){width="1.9680413385826772in"
...
- The cross-entropy loss mitigates this. When calculating the derivative
  ...
  ![](docs\statistics\media/media/image58.png){width="0.14973972003499564in"
  height="0.2679549431321085in"}, the terms cancel out to yield
  ![](docs\statistics\media/media/image57.png){width="1.235916447944007in"
...
- This result is mathematically elegant: the gradient is simply the
  ...
  ![](docs\statistics\media/media/image66.png){width="0.6155304024496938in"
...
1.  Accuracy:
    ![](docs\statistics\media/media/image71.png){width="2.1402712160979878in"
    height="0.23611548556430445in"}.

2.  Precision:
    ![](docs\statistics\media/media/image56.png){width="2.1402712160979878in"
    height="0.23611548556430445in"}.

3.  Recall:
    ![](docs\statistics\media/media/image102.png){width="2.039417104111986in"
    height="0.23502624671916011in"}.

4.  F1-Score:
    ![](docs\statistics\media/media/image104.png){width="3.6191983814523185in"
    height="0.23520997375328084in"}.

#### Regression Example: Housing Price Residuals

Given Error:
![](docs\statistics\media/media/image91.png){width="0.5646303587051619in"
height="0.25942475940507437in"} (Outlier). MSE Penalty:
![](docs\statistics\media/media/image78.png){width="0.8539304461942258in"
height="0.23635608048993875in"}. MAE Penalty:
![](docs\statistics\media/media/image87.png){width="0.7844455380577428in"
...
True Label: Positive
(![](docs\statistics\media/media/image83.png){width="0.3703838582677165in"
height="0.25700021872265966in"}). Model Logits:
![](docs\statistics\media/media/image82.png){width="0.7175667104111986in"
height="0.2366447944006999in"}. Softmax:
![](docs\statistics\media/media/image100.png){width="2.6401563867016624in"
height="0.2891240157480315in"}. Loss:
![](docs\statistics\media/media/image73.png){width="2.9244794400699914in"
height="0.2575962379702537in"}. If model predicted
![](docs\statistics\media/media/image77.png){width="0.7175667104111986in"
height="0.2366447944006999in"}
(![](docs\statistics\media/media/image49.png){width="1.3477712160979878in"
height="0.2588943569553806in"}): Loss:
![](docs\statistics\media/media/image85.png){width="1.9079057305336833in"
